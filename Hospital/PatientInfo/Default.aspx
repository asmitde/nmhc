<%@ Page Title="" Language="C#" MasterPageFile="~/Hospital/Hospital.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Hospital_PatientInfo_Default" %>
                ...
                <table style="width: 760px">
                    <tr>
                        ...
                        <td colspan="2" style="width: 350px">
                            <asp:Label ID="Department" runat="server" Width="200px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        <td style="width: 120px">
                            <asp:Label ID="Label18" runat="server" AssociatedControlID="Bed" 
                                Text="Bed No.:"></asp:Label>
                        </td>
                        <td colspan="2" style="width: 350px">
                            <asp:Label ID="Bed" runat="server" Width="200px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="2" style="width: 350px">
                            <asp:Label ID="Name" runat="server" Width="350px"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" style="width: 474px">
                                <tr>
                                    ...
                                    <td style="width: 66px">
                                        <asp:Label ID="AgeValue" runat="server"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label ID="AgeUnit" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="width: 120px">
                            <asp:Label ID="Label64" runat="server" AssociatedControlID="BMI" Text="BMI:"></asp:Label>
                        </td>
                        <td colspan="2" style="width: 350px">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
								<tr>
									...
									<td style="width: 64px">
										<asp:Label ID="Label65" runat="server" AssociatedControlID="BMIClass" 
											Text="BMI Class:"></asp:Label>
									</td>
									<td>
										<asp:Label ID="BMIClass" runat="server"></asp:Label>
									</td>
								</tr>
							</table>
                        </td>
                        ...
                        <td colspan="2" style="width: 350px">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
								<tr>
									...
									<td>
										<asp:Label ID="CoRelation" runat="server"></asp:Label>
									</td>
								</tr>
							</table>
                        </td>
                    ...
                    <tr>
                        <td style="width: 140px">
                            <asp:Label ID="IfDischarged" runat="server" Font-Bold="True" 
                        ...
                        <td colspan="2" style="width: 350px">
                            <asp:Label ID="MotherName" runat="server"></asp:Label>
						</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td colspan="2" style="width: 350px">
                            <asp:Label ID="MLC" runat="server"></asp:Label>
						</td>
                        <td>
                            &nbsp;</td>
                    </tr>
                        ...
                        <td colspan="5">
                            <table cellpadding="0" cellspacing="0" style="width: 742px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="RContact" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="2">
                            <asp:Label ID="PrevTreated" runat="server" Text="Previously Treated"></asp:Label>
                        </td>
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" style="width: 474px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="PrevID" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="Financing" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="5">
                            <table cellpadding="0" cellspacing="0" style="width: 742px">
                                <tr>
                                    ...
                                    <td style="width: 125px">
                                        <asp:Label ID="LPincode" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" style="width: 383px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="LContact1" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="LContact2" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td colspan="5">
                            <asp:Label ID="PAddress" runat="server"></asp:Label>
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
                        ...
                        <td colspan="5">
                            <table cellpadding="0" cellspacing="0" style="width: 742px">
                                <tr>
                                    ...
                                    <td style="width: 125px">
                                        <asp:Label ID="PPincode" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" style="width: 383px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="PContact1" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="PContact2" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="5">
                            <table cellpadding="0" cellspacing="0" style="width: 742px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="CRelation" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" style="width: 383px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="CContact1" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="CContact2" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="5">
                            <table cellpadding="0" cellspacing="0" style="width: 742px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="ARelation" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="5">
                            <table cellpadding="0" cellspacing="0" style="width: 742px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="AAddress" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="3">
                            <table cellpadding="0" cellspacing="0" style="width: 383px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="AContact1" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td colspan="2">
                            <table cellpadding="0" cellspacing="0" style="width: 350px">
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="AContact2" runat="server"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
