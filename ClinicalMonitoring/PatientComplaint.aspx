<%@ Page Title="Hospital | Clinical Monitoring" Language="C#" MasterPageFile="~/ClinicalMonitoring/ClinicalMonitoring.master" AutoEventWireup="true" CodeFile="PatientComplaint.aspx.cs" Inherits="ClinicalMonitoring_PatientComplaint" %>
            ...
            <asp:View ID="View1" runat="server">
				<div>
					...
					<asp:ListView ID="ListView1" runat="server" DataKeyNames="P_ID,LogDate,LogTime" 
						...
						<InsertItemTemplate>
							<tr style="">
								...
								<td>
									<asp:TextBox ID="PatientComplaintTextBox" runat="server" 
										Text='<%# Bind("PatientComplaint") %>' TextMode="MultiLine" Width="400px" Height="100px" />
								</td>
								<td>
						...
						<ItemTemplate>
							<tr style="">
								...
								<td>
									<asp:Label ID="PatientComplaintLabel" runat="server" 
										Text='<%# Eval("PatientComplaint") %>' Height="100px" Width="400px" />
								</td>
								<td>
					...
					<asp:EntityDataSource ID="EntityDataSource1" runat="server" 
						...
						EntitySetName="Clinical_Monitoring__Patient_Complaint" 
