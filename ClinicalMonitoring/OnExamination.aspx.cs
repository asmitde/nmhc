...
public partial class ClinicalMonitoring_OnExamination : System.Web.UI.Page
{
			...
			if (PID != null)
			{
				using (NMHCDatabaseEntities myEntities = new NMHCDatabaseEntities())
				{
					...
					if (p != null && p.H_ID == hid)
					{
						...
						var dates = (from r in myEntities.Clinical_Monitoring__On_Examination
									 where r.P_ID == PID
	...
	{
		Clinical_Monitoring__On_Examination record = (Clinical_Monitoring__On_Examination)e.Entity;
	...
	protected void Search_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect(String.Format("~/ClinicalMonitoring/OnExamination.aspx?PID={0}", pid));
	}
