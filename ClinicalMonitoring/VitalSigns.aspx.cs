...
public partial class ClinicalMonitoring_VitalSigns : System.Web.UI.Page
{
			...
			if (PID != null)
			{
				using (NMHCDatabaseEntities myEntities = new NMHCDatabaseEntities())
				{
					...
					if (p != null && p.H_ID == hid)
					{
						...
						var dates = (from r in myEntities.Clinical_Monitoring__Vital_Signs
									 where r.P_ID == PID
	...
	{
		Clinical_Monitoring__Vital_Signs record = (Clinical_Monitoring__Vital_Signs)e.Entity;
	...
	protected void Search_Click(object sender, EventArgs e)
	{
		...
		Response.Redirect(String.Format("~/ClinicalMonitoring/VitalSigns.aspx?PID={0}", pid));
	}
